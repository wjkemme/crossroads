...
namespace crossroads {
    enum class ApproachId : uint8_t { North = 0, East = 1, South = 2, West = 3 };

    enum class MovementType : uint8_t { Straight = 0, Left = 1, Right = 2 };
    ...
    inline IntersectionConfig makeDefaultIntersectionConfig() {
        ...
        config.approaches[0] = {ApproachId::North,
                                "North",
                                {{laneIdFor(ApproachId::North, 0), "N-0", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::North, 1), "N-1", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::North, 2), "N-2", {MovementType::Right}, true, true, true}}};
        config.approaches[1] = {ApproachId::East,
                                "East",
                                {{laneIdFor(ApproachId::East, 0), "E-0", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::East, 1), "E-1", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::East, 2), "E-2", {MovementType::Right}, true, true, true}}};
        config.approaches[2] = {ApproachId::South,
                                "South",
                                {{laneIdFor(ApproachId::South, 0), "S-0", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::South, 1), "S-1", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::South, 2), "S-2", {MovementType::Right}, true, true, true}}};
        config.approaches[3] = {ApproachId::West,
                                "West",
                                {{laneIdFor(ApproachId::West, 0), "W-0", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::West, 1), "W-1", {MovementType::Straight}, true, true, true},
                                 {laneIdFor(ApproachId::West, 2), "W-2", {MovementType::Right}, true, true, true}}};
